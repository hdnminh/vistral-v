...
# Version 2: with WIT dataset pretrain + LLAVA SFT
...
deepspeed llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/llava-vistral-7b-pretrain-2/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-vistral-7b-lora-2 \
    --num_train_epochs 1 \
